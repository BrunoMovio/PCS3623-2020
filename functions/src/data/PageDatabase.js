...
exports.PageDatabase = void 0;
var BaseDatabase_1 = require("./BaseDatabase");
var Page_1 = require("../model/Page");
var PageDatabase = /** @class */ (function (_super) {
    __extends(PageDatabase, _super);
    function PageDatabase() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    PageDatabase.prototype.getPageByPartialName = function (partialName) {
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, result.map(function (item) {
                                return Page_1.Page.toPageModel(__assign({}, item));
                            })];
                    case 2:
                        error_1 = _a.sent();
    ...
    PageDatabase.prototype.getLikesByPageId = function (pageId) {
        return __awaiter(this, void 0, void 0, function () {
            var pageLikes, error_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                    ...
                    case 1:
                        pageLikes = _a.sent();
                        return [2 /*return*/, pageLikes.map(function (result) { return result.user_id; })];
                    case 2:
                        error_2 = _a.sent();
    ...
    PageDatabase.prototype.getAll = function () {
        return __awaiter(this, void 0, void 0, function () {
            var result, error_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
...
exports.PageDatabase = PageDatabase;
