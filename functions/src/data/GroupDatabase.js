...
var GroupDatabase = /** @class */ (function (_super) {
    ...
    GroupDatabase.prototype.getUsersByGroupId = function (groupId) {
    ...
    GroupDatabase.prototype.getGroupsByAdminId = function (adminId) {
        return __awaiter(this, void 0, void 0, function () {
            var result, error_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        result = _a.sent();
                        return [2 /*return*/, result.map(function (item) {
                                return Group_1.Group.toGroupModel(__assign({}, item));
                            })];
                    case 2:
                        error_2 = _a.sent();
    ...
    GroupDatabase.prototype.getAll = function () {
        return __awaiter(this, void 0, void 0, function () {
            var result, error_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
